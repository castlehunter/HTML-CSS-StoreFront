...
window.onload = function() {
    var figureContainer = document.querySelector("#figs");

    var myImages = "";

    for (var i = 0; i < images.length; i++) {
        myImages += '<figure><img alt="' + images[i].alt + '" src="' + images[i].url + '"> <figcaption>' + images[i].caption + "</figcaption> </figure>";
    };

    figureContainer.innerHTML = myImages;
}